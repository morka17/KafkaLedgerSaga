...
export class InitAuditSchema1700000000000 implements MigrationInterface {
  name = 'InitAuditSchema1700000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX idx_audit_log_aggregate ON audit_ledger.audit_log ("aggregateId");`);
    await queryRunner.query(`CREATE INDEX idx_audit_log_correlation ON audit_ledger.audit_log ("correlationId");`);
  }
